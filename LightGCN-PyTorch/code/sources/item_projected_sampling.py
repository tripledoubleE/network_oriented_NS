...
def get_min_sim_score(sim_dict, start_node):

    sorted_dict = sorted(sim_dict[start_node].items(), key=lambda x: x[1], reverse=False)
...
#def get_min_cos_sim(embedding, start_node):
