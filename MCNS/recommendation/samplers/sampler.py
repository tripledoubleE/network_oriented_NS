...
def negative_sampling(model, sess, candidates, start_given, q_1_dict, N_steps, N_negs, node1, node2, args, support=None, feats=None, placeholders=None):
    ...
    print("NEGATIVE SAMPLING FUNCTION ")
    print('q_1_dict keys len')
    print(len(list(q_1_dict.keys())))
    print("candidates dict keys len ")
    print(len(list(candidates.keys())))
    if set(list(q_1_dict.keys())) == set(list(candidates.keys())):
        print("YESSS")
